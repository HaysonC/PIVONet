...
def _parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--output", default="data/demo/demo_orchestrator_bundle.npz", help="Relative or absolute output path for the synthetic bundle.")
    parser.add_argument("--particles", type=int, default=64, help="Number of particles to synthesize.")
    parser.add_argument("--steps", type=int, default=40, help="Number of timesteps to synthesize.")
    parser.add_argument("--dt", type=float, default=0.05, help="Timestep spacing for generated history.")
...
def main() -> None:
    ...
    timesteps = np.linspace(0.0, args.dt * (args.steps - 1), num=args.steps, endpoint=True)
